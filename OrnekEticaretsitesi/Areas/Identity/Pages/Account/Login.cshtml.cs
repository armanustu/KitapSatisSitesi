    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            returnUrl ??= Url.Content("~/");
                    ...
                    //Login olan kullanıcıyı buluyoruz sonra login olan kullanıcının sepetine eklediği ürün sayısını buluyoruz
                    var user = _db.ApplicationUsers.FirstOrDefault(i => i.Email == Input.Email);
                    int count = _db.ShopingCharts.Where(i => i.ApplicationUserID == user.Id).Count();
